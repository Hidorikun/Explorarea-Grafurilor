...
<div id="container">
		...
		<tr>
			<td valign="top" colspan="2" align="center">
					<p></p>
					<p>Please check out the <a target="_blank"  href="http://www.instantwp.com/faq">FAQ</a> and <a target="_blank"  href="http://www.instantwp.com/unleashed/">Deployment Guide - Instant WordPress Unleashed</a> or some recommended <a target="_blank"  href="http://www.instantwp.com/wordpress-resources/">WordPress Resources</a></p>
					<p></p>
			</td>
		</tr>
		<? } ?>
	...
	<div id="container-footer">
			...
			<br/>InstantWP © 2012 Corvideon - THIS SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND.
		 </div>
         </div>
</div> <!-- END container -->
</body>
